...
Flat.create!(
  name: 'Cozy & Spacious Flat Close to subway',
  address: '120 Grifton Park London SW8 3DT',
  picture_url: 'https://unsplash.com/photos/b87_egH5mos?w=1200',
  description: 'A lovely and cozy flat. one double bedrooms, close to subway station',
  price_per_night: 75,
  number_of_guests: 2
)
